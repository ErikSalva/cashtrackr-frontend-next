...
export async function editBudget(budgetId: Budget['id'], prevState: ActionStateType, formData: FormData) {
    ...
    // esto reevalida toda las ruta admin con todas las peticiones que se hagan
    //mientras que revalidateTag solo reevalida las peticiones que tengan el tag especificado     //revalidateTag('/all-budgets')
