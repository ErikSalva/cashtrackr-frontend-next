...
async function getUserBudgets() {
    ...
    const req = await fetch(url, {
        ...
        // Esto es util para no tener que usar revalidate sobre todo cuando tenemos muchos datos
        // Asi podemos solo hacer refecht a los datos que se modifican
        next: {
            tags: ['all-budgets']
        }
    })
...
export default async function AdminPage() {
    ...
    // Los server actions solo deben usarse para acciones que modifiquen datos(crear, editar o eliminar) o mutaciones
    // No deben usarse para obtener datos, para eso se usan los fetch normales
